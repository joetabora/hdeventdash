...
function TopHeaderInner({ onMenuToggle, userEmail }: TopHeaderProps) {
  ...
  return (
    <header className="print:hidden sticky top-0 z-20 h-16 bg-harley-dark/90 backdrop-blur-xl border-b border-harley-gray flex items-center justify-between px-4 lg:px-8">
