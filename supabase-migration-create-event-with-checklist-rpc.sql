...
BEGIN
  ...
  FROM (
    VALUES
      ...
      ('Pre-Event Preparation', 'Event → Website: proofread summary, SEO title, and meta description in the page builder', 12),
      ('Pre-Event Preparation', 'Event → Website: upload hero/web banners and verify mobile + desktop layouts', 13),
      ('Pre-Event Preparation', 'Event → Website: publish (or schedule) and copy the final public URL into Marketing & publish', 14),
      ('Pre-Event Preparation', 'Event → Facebook: create the FB event with correct date, time, and address', 15),
      ('Pre-Event Preparation', 'Event → Facebook: add cover + key graphics; pin essentials in discussion if needed', 16),
      ('Pre-Event Preparation', 'Share event details with team managers', 17),
      ('Pre-Event Preparation', 'Assign staff roles (grill, games, raffles, etc.)', 18),
      ('Pre-Event Preparation', 'Create layout (indoor/outdoor) and present to managers', 19),
      -- Checklist / Materials
